...
def createSomeIP(SenderConfig, ReceiverConfig, MsgConfig):
    ...
    # payload controlável (p/ Tamper/Fuzzy/Replay); se ausente, aleatório como no original
    pl = MsgConfig['payload'] if MsgConfig.get('payload') is not None else createPayload()
